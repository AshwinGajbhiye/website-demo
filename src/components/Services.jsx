    ...
    <section className="text-center">
      <div className="container mx-auto px-4 relative h-screen w-full mt-10">
        ...
        <h2 className="text-4xl font-semibold mb-12">
          ...
          <span ref={title2Ref} className="title2 block">
            designed to meet your needs.
          </span>
        </h2>

        <div className="flex flex-wrap justify-center gap-6 mt-20">
          <div className="p-8 shadow-md rounded-xl bg-white transition-transform transform hover:scale-105 max-w-[17rem] min-h-[22rem]">
            ...
            <h3 className="text-lg font-semibold mt-6 mb-4">Web Design</h3>
          ...
          <div className="p-8 shadow-md rounded-xl bg-white transition-transform transform hover:scale-105 max-w-[17rem] min-h-[22rem]">
            <div className="w-12 h-12 bg-white flex justify-center items-center text-black text-4xl rounded-full mx-auto shadow-md">
              <IonIcon className="w-7 h-7 font-bold" icon={codeSlashOutline} />
            </div>
            <h3 className="text-lg font-semibold mt-6 mb-4">Web Development</h3>
            <p className="text-gray-600 mb-6">
          ...
          <div className="p-8 shadow-md rounded-xl bg-white transition-transform transform hover:scale-105 max-w-[17rem] min-h-[22rem]">
            ...
            <h3 className="text-lg font-semibold mt-6 mb-4">Video Editing</h3>
            <p className="text-gray-600 mb-6">
              Elevate your brand with our video editing services. We craft
              engaging, professional videos that captivate audiences and enhance
              your message.
            </p>
            <a
              href="#"
          ...
          <div className="p-8 shadow-md rounded-xl bg-white transition-transform transform hover:scale-105 max-w-[17rem] min-h-[22rem]">
            ...
            <h3 className="text-lg font-semibold mt-6 mb-4">Logo Design</h3>
            <p className="text-gray-600 mb-6">
              Boost your brand with our creative logo and product design. We
              make eye-catching, memorable designs that help your business stand
              out.
            </p>
            <a
              href="#"
